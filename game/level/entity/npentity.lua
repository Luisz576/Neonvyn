...
-- constructor
function NPEntity:new(entityType, x, y, width, height, groups, hitboxRelationX, hitboxRelationY)
    local instance = Entity:new(entityType, x, y, width, height, groups, hitboxRelationX, hitboxRelationY)
